...
@Component({
  selector: 'app-radar-statistic',
  templateUrl: './radar-statistic.component.html',
  styleUrls: ['./radar-statistic.component.scss']
})
export class RadarStatisticComponent implements OnInit {
