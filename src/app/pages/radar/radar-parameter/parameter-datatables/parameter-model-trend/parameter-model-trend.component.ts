...
@Component({
  selector: 'app-parameter-model-trend',
  templateUrl: './parameter-model-trend.component.html',
  styleUrls: ['./parameter-model-trend.component.scss']
})
export class ParameterModelTrendComponent implements OnInit {
