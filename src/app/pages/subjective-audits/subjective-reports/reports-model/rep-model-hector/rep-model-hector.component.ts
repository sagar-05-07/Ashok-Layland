...
@Component({
  selector: 'app-rep-model-hector',
  templateUrl: './rep-model-hector.component.html',
  styleUrls: ['./rep-model-hector.component.scss']
})
export class RepModelHectorComponent implements OnInit {
