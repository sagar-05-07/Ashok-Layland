...
@Component({
  selector: 'app-rep-model-gloster',
  templateUrl: './rep-model-gloster.component.html',
  styleUrls: ['./rep-model-gloster.component.scss']
})
export class RepModelGlosterComponent implements OnInit {
