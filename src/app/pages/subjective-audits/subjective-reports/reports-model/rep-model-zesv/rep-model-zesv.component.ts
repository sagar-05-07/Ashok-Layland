...
@Component({
  selector: 'app-rep-model-zesv',
  templateUrl: './rep-model-zesv.component.html',
  styleUrls: ['./rep-model-zesv.component.scss']
})
export class RepModelZesvComponent implements OnInit {
