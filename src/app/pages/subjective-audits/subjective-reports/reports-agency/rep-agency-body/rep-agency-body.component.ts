...
@Component({
  selector: 'app-rep-agency-body',
  templateUrl: './rep-agency-body.component.html',
  styleUrls: ['./rep-agency-body.component.scss']
})
export class RepAgencyBodyComponent implements OnInit {
