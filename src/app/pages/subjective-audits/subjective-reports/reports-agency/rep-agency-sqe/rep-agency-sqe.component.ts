...
@Component({
  selector: 'app-rep-agency-sqe',
  templateUrl: './rep-agency-sqe.component.html',
  styleUrls: ['./rep-agency-sqe.component.scss']
})
export class RepAgencySqeComponent implements OnInit {
