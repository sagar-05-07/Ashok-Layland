...
@Component({
  selector: 'app-rep-agency-ga',
  templateUrl: './rep-agency-ga.component.html',
  styleUrls: ['./rep-agency-ga.component.scss']
})
export class RepAgencyGaComponent implements OnInit {
