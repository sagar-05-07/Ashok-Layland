...
@Component({
  selector: 'app-rep-agency-press',
  templateUrl: './rep-agency-press.component.html',
  styleUrls: ['./rep-agency-press.component.scss']
})
export class RepAgencyPressComponent implements OnInit {
