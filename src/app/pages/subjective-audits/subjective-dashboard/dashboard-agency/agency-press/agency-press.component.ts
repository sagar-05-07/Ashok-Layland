...
@Component({
  selector: 'app-agency-press',
  templateUrl: './agency-press.component.html',
  styleUrls: ['./agency-press.component.scss']
})
export class AgencyPressComponent implements OnInit {
