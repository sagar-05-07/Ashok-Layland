...
@Component({
  selector: 'app-agency-paint',
  templateUrl: './agency-paint.component.html',
  styleUrls: ['./agency-paint.component.scss']
})
export class AgencyPaintComponent implements OnInit {
  showXAxis1 = true;
  showYAxis1 = true;
  gradient1 = false;
