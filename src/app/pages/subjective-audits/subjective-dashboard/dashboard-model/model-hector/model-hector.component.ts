...
@Component({
  selector: 'app-model-hector',
  templateUrl: './model-hector.component.html',
  styleUrls: ['./model-hector.component.scss']
})
export class ModelHectorComponent implements OnInit {
