...
@Component({
  selector: 'app-addpillar',
  templateUrl: './addpillar.component.html',
  styleUrls: ['./addpillar.component.scss']
})
export class AddpillarComponent implements OnInit {
  //  data: any;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AddpillarComponent>,
