...
@Component({
  selector: 'app-rader-gloster',
  templateUrl: './rader-gloster.component.html',
  styleUrls: ['./rader-gloster.component.scss']
})
export class RaderGlosterComponent implements OnInit {
  showXAxis1 = true;
  showYAxis1 = true;
  gradient1 = false;
