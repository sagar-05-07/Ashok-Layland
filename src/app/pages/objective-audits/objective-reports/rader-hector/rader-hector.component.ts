...
@Component({
  selector: 'app-rader-hector',
  templateUrl: './rader-hector.component.html',
  styleUrls: ['./rader-hector.component.scss']
})
export class RaderHectorComponent implements OnInit {
