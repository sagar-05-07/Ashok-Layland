...
@Component({
  selector: 'app-objective-alerts',
  templateUrl: './objective-alerts.component.html',
  styleUrls: ['./objective-alerts.component.scss']
})
export class ObjectiveAlertsComponent implements OnInit {
