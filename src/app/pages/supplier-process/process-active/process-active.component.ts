...
import { AdddCasesComponent } from './addd-cases/addd-cases.component';

@Component({
  selector: 'app-process-active',
  templateUrl: './process-active.component.html',
  styleUrls: ['./process-active.component.scss']
})
export class ProcessActiveComponent implements OnInit {
