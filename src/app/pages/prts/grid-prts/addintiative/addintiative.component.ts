...
@Component({
  selector: 'app-addintiative',
  templateUrl: './addintiative.component.html',
  styleUrls: ['./addintiative.component.scss']
})
export class AddintiativeComponent implements OnInit {
