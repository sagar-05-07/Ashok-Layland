import { AddFunctionMasterComponent } from './add-function-master/add-function-master.component';
import { Component, OnInit } from '@angular/core';
import { MatDialog } from '@angular/material/dialog';
import { environment } from 'src/environments/environment';

@Component({
  selector: 'app-fuction-master',
  templateUrl: './fuction-master.component.html',
  styleUrls: ['./fuction-master.component.scss']
})
export class FuctionMasterComponent implements OnInit {
  ...
  public addfunction(item){
    this.dialog.open(AddFunctionMasterComponent,{
      data:item,
      width:"600px",
      height:"auto"
    })
