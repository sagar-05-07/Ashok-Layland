...
@Component({
  selector: 'app-prts-new-issue',
  templateUrl: './prts-new-issue.component.html',
  styleUrls: ['./prts-new-issue.component.scss']
})
export class PrtsNewIssueComponent implements OnInit {
